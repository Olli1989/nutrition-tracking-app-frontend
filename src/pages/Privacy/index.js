  ...
  return (
    <Main>
        ...
        <Box sx={{width: '80%', mx: 'auto', mt: 3}}>
            <Typography variant="h1" component="h4">Erklärung zur Informationspflicht</Typography>
            <br/>      
            <p align="center">      
            ...
            <p>
                ...
                Wir erheben und verarbeiten personenbezogene Daten nur auf Grundlage der gesetzlichen      
            ...
            <p>Sie als Betroffener haben bezüglich Ihrer Daten, welche bei uns gespeichert sind grundsätzlich ein Recht auf:</p>      
                ...
                <p>Auskunft</p>
                <p>Löschung der Daten</p>
                <p>Berichtigung der Daten</p>
                <p>Übertragbarkeit der Daten</p>
            ...
            <p>
                ...
                so haben Sie die Möglichkeit sich bei uns (max.mustermann@gmx.at) oder der Datenschutzbehörde zu beschweren.
            </p>
            <h5>Sie erreichen uns unter folgenden Kontaktdaten:</h5>        
            <p>
                <b>Webseitenbetreiber:</b> 
                Max Mustermann
                <br/> 
                <b>Telefonnummer:</b> 
                0650/1234567
